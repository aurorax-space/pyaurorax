...
from pyucalgarysrs.exceptions import SRSAPIError, SRSError
from pyucalgarysrs.models.atm import (
    ...
    ATM_DEFAULT_SPECIAL_LOGIC_KEYWORD,
)
from ...exceptions import AuroraXAPIError, AuroraXError
if TYPE_CHECKING:
...
class ATMManager:
    ...
    def forward(self,
        ...
        **NOTE**: As of PyAuroraX version 1.26.0, `maxwellian_energy_flux` defaults to 0. At least one energy flux must
        be nonzero, or a `custom_spectrum` supplied, otherwise the API returns an error.
        ...
        Raises:
            ...
            pyaurorax.exceptions.AuroraXError: both `maxwellian_characteristic_energy` and `maxwellian_mean_energy` were given
        """
        try:
    ...
    def inverse(self,
        ...
        **NOTE**: As of PyAuroraX version 1.26.0, `precipitation_flux_spectral_type` is required.
        ...
        Raises:
            pyaurorax.exceptions.AuroraXAPIError: An API error was encountered
            pyaurorax.exceptions.AuroraXError: `precipitation_flux_spectral_type` was missing or invalid
        """
        try:
