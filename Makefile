.PHONY: install update get-test-data docs test test-docs test-linting test-pycodestyle test-bandit test-pytest test-pytest test-pytest-search-rw test-pytest-notebooks test-coverage show-outdated tool-checks publish
