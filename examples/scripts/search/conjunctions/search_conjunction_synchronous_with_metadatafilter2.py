...
def main():
    ...
    expression_1 = aurorax.search.MetadataFilterExpression("ucalgary_themis_apa_ml_v2", "classified as APA", operator="=")
    expression_2 = aurorax.search.MetadataFilterExpression("ucalgary_themis_apa_ml_v2_confidence", 95, operator=">=")
