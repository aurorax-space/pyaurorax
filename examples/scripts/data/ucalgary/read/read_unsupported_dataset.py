...
dataset = aurorax.data.ucalgary.list_datasets("THEMIS_ASI_RAW_ROW2")[0]
...
try:
    ...
    print()
    print(data)
except pyaurorax.AuroraXUnsupportedReadError as e:
    print("Expected error occurred\n\n[pyaurorax.AuroraXUnsupportedReadError]: %s\n" % (str(e)))
