...
dataset = aurorax.data.ucalgary.list_datasets("REGO_CALIBRATION_RAYLEIGHS_IDLSAV")[0]
...
data = aurorax.data.ucalgary.readers.read_calibration(file_list, n_parallel=2, dataset=dataset)
